...
for content_type in content_types:
    ...
    num_of_classes = len(unique_anss)
    ...
    answers = np.array([get_one_hot_vector(x["answer"],unique_anss) for x in train_qns])
    ...
    test_qns = [x for x in test_qns if x['content_type']==content_type and x["answer_type"]=="OPEN" and x['q_lang'] == 'en']
    ...
    test_answers = np.array([get_one_hot_vector(x["answer"],unique_anss) for x in test_qns])
    ...
    print(content_type+" Open Model Saved.")